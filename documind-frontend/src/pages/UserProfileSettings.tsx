      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-gradient-to-b from-transparent via-transparent to-[#f5f5f5]/50 dark:to-[#0f0f0f]/50">
          <div className="max-w-[1200px] mx-auto px-6 sm:px-8 lg:px-12 py-10 lg:py-12">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-0.5 border-b border-[#e5e5e5] dark:border-[#262626] overflow-x-auto">
                {tabs.map((tab) => {
                  const Icon = tab.icon;
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "relative flex items-center gap-1.5 px-3 py-2 text-xs font-medium transition-colors duration-200 whitespace-nowrap",
                        "border-b-2 -mb-px",
                        isActive
            ...
            <div className="space-y-4">
              {activeTab === "security" && (
                <div className="bg-white dark:bg-[#171717] border border-[#e5e5e5] dark:border-[#262626] rounded-xl shadow-none hover:shadow-sm transition-shadow duration-300">
                  <div className="px-5 py-4 border-b border-[#e5e5e5] dark:border-[#262626]">
                    <h2 className="text-base font-medium text-[#171717] dark:text-[#fafafa] mb-0.5">
                      Change Password
                    </h2>
                      ...
                      <div className="bg-white dark:bg-[#171717] border border-[#e5e5e5] dark:border-[#262626] rounded-xl shadow-none hover:shadow-sm transition-shadow duration-300">
                        <div className="px-5 py-4 border-b border-[#e5e5e5] dark:border-[#262626]">
                          <div className="flex items-center justify-between">
                            ...
                            <OrganizationIcon className="h-3.5 w-3.5 text-[#737373] dark:text-[#a3a3a3]" />
                          </div>
                        </div>
                        <div className="p-5">
                      ...
                      <div className="bg-white dark:bg-[#171717] border border-[#e5e5e5] dark:border-[#262626] rounded-xl shadow-none hover:shadow-sm transition-shadow duration-300">
                        <div className="px-5 py-4 border-b border-[#e5e5e5] dark:border-[#262626]">
                          <div className="flex items-center justify-between">
                            ...
                            <Users className="h-3.5 w-3.5 text-[#737373] dark:text-[#a3a3a3]" />
                          </div>
                        </div>
                        <div className="p-5">
                          <p className="text-xs text-[#737373] dark:text-[#a3a3a3] mb-3">
                    ...
                    <div className="bg-white dark:bg-[#171717] border border-[#e5e5e5] dark:border-[#262626] rounded-xl shadow-none hover:shadow-sm transition-shadow duration-300">
                      ...
                      <div className="p-5">
                        ...
                        <Button
                          ...
                          className="w-full sm:w-auto h-7 text-xs bg-[#171717] dark:bg-[#fafafa] text-[#fafafa] dark:text-[#171717] hover:bg-[#262626] dark:hover:bg-[#e5e5e5]"
                        >
