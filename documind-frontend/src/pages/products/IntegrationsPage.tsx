      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="space-y-20">
          ...
          <section>
            <div className="max-w-4xl">
              <div className="inline-block mb-4">
                <span className="text-[10px] font-medium text-white/40 uppercase tracking-wider">Connect Everything</span>
              </div>
          ...
          <section>
            <div className="mb-12">
              <div className="inline-block mb-3">
                <span className="text-[10px] font-medium text-white/40 uppercase tracking-wider">Popular Integrations</span>
              </div>
            ...
            <div className="space-y-10">
              ...
              <div>
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-lg border border-white/10 bg-white/[0.02] flex items-center justify-center">
                    <div className="w-6 h-6 text-white/30">
                      <CloudStorageIcon />
                    </div>
                  </div>
                  <h3 className="text-base font-medium text-white">Cloud Storage</h3>
                </div>
                    ...
                    >
                      <div className="h-full relative">
                        ...
                        <div className="relative p-4 text-center">
                          <h4 className="text-xs font-medium text-white/70 group-hover:text-white/90 transition-colors">
                            {name}
                          </h4>
                        </div>
                      </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-base font-medium text-white">Collaboration</h3>
                </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-base font-medium text-white">Development</h3>
                </div>
          ...
          <section>
            <div className="mb-12">
              <div className="inline-block mb-3">
                <span className="text-[10px] font-medium text-white/40 uppercase tracking-wider">API & Development</span>
              </div>
              <h2 className="text-2xl sm:text-3xl font-medium mb-4 text-white leading-tight max-w-3xl">
