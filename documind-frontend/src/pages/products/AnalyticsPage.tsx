          ...
          <section>
            <div className="max-w-4xl">
              <div className="inline-block mb-4">
                <span className="text-[10px] font-medium text-white/40 uppercase tracking-wider">Data-Driven Decisions</span>
              </div>
          ...
          <section>
            <div className="mb-12">
              <div className="inline-block mb-3">
                <span className="text-[10px] font-medium text-white/40 uppercase tracking-wider">Core Analytics</span>
              </div>
